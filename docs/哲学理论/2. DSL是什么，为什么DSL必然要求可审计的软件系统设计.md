# DSL是什么，为什么DSL必然要求可审计的软件系统设计
此章为总章子章节2. 新流程（结构驱动型自动流水线）详细解释
---
## 1. 什么是DSL
...
而江苏（偏离研发主航道的）绝大多数项目（不点名）的真实特征是：
...
<big style="color: red">控制逻辑难以追踪：业务规则的变更难以审计和追溯。不能很好的支持DSL的可审计需求。</big>
