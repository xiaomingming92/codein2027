...
### 这是哲学理论和意图驱动项目 Human Intent Operating Systemed Project · 长周期AI自主开发工程化实现
...
---
### 📢 首创官方声明
**ADD (Audit-Driven Development) 审计驱动开发范式 由 xiaomingming92 于 2026年5月 全球首创，并完成业内首个端到端工程化落地。**
本仓库为 ADD 范式**唯一原始官方实现**。如果你觉得这东西有价值，**给个 Star 是对原创最基本的尊重**——不费电，但能让作者知道有人在认真读。AGPL-3.0 不为卡脖子，**专治那种"抄完代码改个名就当自己的、完了还回头踩一脚"的行为**。借鉴思想没问题，把出处标上，大家认知对齐；伸手扒代码还不认账的，许可证会替原创者说话。
...
**农业智能体**完成了验证——ADD 范式完整落地到真实产品，经过 3 轮独立对话迭代验证。

### 一个经常被问的问题：为什么有"co-agent"和"团队协同智能体"？
...
项目已完成 **3 轮独立完整对话迭代验证**，全流程跑通长周期开发链路，充分证明 ADD 范式的可行性与工程价值。
...
- [技术架构说明书](docs/大田精准耕播智能决策系统/knowledge/01-架构/《大田精准耕播智能决策系统技术架构说明书》.md) - 系统分层、证据链推理、LangGraph 工程化、裁决层设计
- [决策管线架构说明书](docs/大田精准耕播智能决策系统/knowledge/01-架构/《大田精准耕播智能决策系统决策管线架构说明书》.md) - 决策管线设计
...
- [AI 智能体架构与工作流规范](docs/大田精准耕播智能决策系统/knowledge/01-架构/《AI智能体架构与工作流规范》.md) - 智能体架构设计规范
- [智能体总体架构说明书](docs/大田精准耕播智能决策系统/knowledge/01-架构/《智能体总体架构说明书》.md) - 智能体总体设计
...
- [AI 智能体核心规范](docs/大田精准耕播智能决策系统/knowledge/02-规范/《AI智能体核心规范》.md) - 智能体核心约束
- [统一状态机规范](docs/大田精准耕播智能决策系统/knowledge/02-规范/《统一状态机规范》.md) - 状态机设计规范

### 需求文档 (PRD)

- [大田精准耕播智能决策系统规划说明书](docs/大田精准耕播智能决策系统/knowledge/00-需求/《大田精准耕播智能决策系统规划说明书》.md)
