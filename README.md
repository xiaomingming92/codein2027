...
> **这个办法就是 [add-coder](https://www.npmjs.com/package/add-coder)** —— 一行 `npx add-coder init` 即可在任何项目中部署完整的 ADD 工作流（模板 + hooks + MCP 工具链 + 审计数据库），零依赖公司内部设施。详见 [add-coder README](https://www.npmjs.com/package/add-coder?activeTab=readme)。
